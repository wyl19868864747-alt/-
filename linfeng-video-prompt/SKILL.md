...
description: 以“林枫视频提示词skill”的方法，把产品Brief、脚本、分镜、故事板、参考视频或成片问题转化为精炼、具象、可直接生成的视频提示词、导演分析或分镜交付。先以“双轴创作判断”确定成片服务对象与提示词控制主导层，再用并行能力标签叠加所有适用模块；分流只决定验收重点和提示词带宽，不屏蔽跨片型通用规则。建立氛围、色彩、光线、成像与声音母规则；商业任务保留商品事实、真实比例、消费者决策、产品证据和品牌记忆，剧情任务强化人物关系、信息控制、表演因果、轴线与连续性。用于TVC、商业广告、UGC、产品演示、纪录片、真人秀、幕后花絮、派对抓拍、新闻采集、街头抓拍、家庭录像、档案电视、特定年代摄影、食品饮料、美妆时尚、群像、多手交互、旁白、短剧、剧情对话、动作戏、一镜到底、复杂运镜、空间揭示、黄金3秒Hook、预测误差、结果前置、动作中途进入、真假对比、延迟揭示、真假虚实结合、写实超现实、视觉奇观广告、真人与不可能事件结合、微缩小人、微缩工厂、微缩产品世界、巨物原料世界、产品世界化、包装变建筑或工厂、产品拆解悬浮、卖点视觉隐喻、视觉蜕变奇观、A→B连续重构、真实摄影与CG/AIGC合成、Grounded Surrealism、Miniature Diorama、Product Spectacle、观察者摄影、早期DV、广播ENG摄像机、手机现场记录、参考视频反推、Seedance 2.0/2.5、LibTV、MiniMax H3、关键帧、故事板、白模、编辑、延长、转场、声音设计、画质诊断、成片复盘、PPM、版本审片与Excel交付。用户说“林枫视频提示词skill”“使用林枫视频提示词skill”，或要求强化前三秒、首秒钩子、开场留存、摄影机像现场中的真人一样发现和反应、建立年代成像真实性、解释镜头为何存在、校准POV/FPV/反打/反应/轴线、修复无因运镜、重复特写、反应缺失、空间混乱、产品比例/物理/效果泄漏、自拍逻辑、低清噪点、压缩或高风格化社媒美妆广告时使用。
---
...
9. **专项机制按条件触发，不与全局原则争权**：`grounded-surreal`、`transformation-spectacle`、`observational-camera`、`golden-3s-hook` 等只在任务语义命中时加载详细reference。写实超现实遵守“先可信现实、每镜一个高权重幻想规则、再回收现实”；视觉蜕变奇观只在“A→B的变化过程本身有机会成为核心看点”时启用，遵守“熟悉动作 → 微悬念 → 明确触发 → 连续传播 → 超预期重构 → 产品/信息收束”，优先让目标不是突然出现而是可观察地诞生；观察者摄影遵守“事件发生 → 摄影者发现/反应 → 追随或重构图 → 恢复 → 落在结果”；黄金3秒通过预测误差形成具体问题并完成 `Hook → Bridge → Payoff`，不把高能等同于快切、巨物、爆炸或大音效。任何专项机制都不得覆盖事实、物理、空间连续性、声音真源与产品/剧情证据。
...
4. 先在后台建立模块覆盖单：`对话阶段｜第一轴｜第二轴｜能力标签（含grounded-surreal、transformation-spectacle、observational-camera、golden-3s-hook等可多选标签）｜必须读取｜可省略及理由`；再把下方所有条件视为并列勾选项逐行匹配并加载专项 references，不得命中第一项后停止。两个及以上镜头必须先完成整片信息设计，再逐镜完成“为什么存在 → 怎样拍”的双层反问；一镜到底把每个连续节拍当作无切镜的信息镜头处理。
...
8. 按“空间/首帧 → 单一主动作 → 接触或变化 → 可见结果 → 反应/决定 → 落幅 → 承接”编译时间轴。先运行方向测试、黄金3秒测试、导演信息测试、人脑成像测试、模型容量测试、物理连续性测试和画质交付测试；随后运行 `Duration Gate`：逐条检查所有独立视频生成提示词，任何 `<4秒` 的生成单元判定为不合格，必须先合并、延长或重构至 `>=4秒` 后才能输出。
