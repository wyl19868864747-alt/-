...
# S01｜FICTIONAL OLD-WORLD ROYAL COURT
## 架空古装宫廷

**状态**：TESTING_CANDIDATE  
**世界发动机**：身份、等级、礼仪、公开审视、权力。  
**无商品天然冲突**：谁能说话、谁能靠近、谁被特殊对待、谁违反礼仪、谁获得/失去权威。  
**人物池**：Ruler / Royal Host、Chamberlain / Steward、Courtier、Attendant、Envoy / Petitioner。  
**社会规则**：接近、发言、递交、触碰、打断都受身份限制；错误会被全场看见。  
...
# S02｜MODERN AMERICAN HIGH SCHOOL
## 现代美国高中

**状态**：TESTING_CANDIDATE / AGE-RESTRICTED ROUTER  
**世界发动机**：同伴评价、群体归属、公开尴尬、课堂规则、时间压力。  
**无商品天然冲突**：被点名、迟到、小组项目、座位/圈层、课堂展示、公开出糗、老师判断错误、同伴误会。  
**人物池**：18+成年演员扮演毕业班Student、Friend、Classmate / Rival、Teacher、Staff。  
**社会规则**：同龄人会快速注意异常；老师拥有局部规则权；铃声/换课带来时间压力。  
...
# S03｜FICTIONAL ANCIENT CAMPAIGN WAR CAMP
## 架空古代战争军营

**状态**：TESTING_CANDIDATE / RESTRICTED VISUAL RULES  
**世界发动机**：任务、命令链、时间压力、资源有限、信息不完整。  
**无商品天然冲突**：命令变化、情报错误、补给不足、Deadline、谁负责、方案失败。  
**人物池**：Commander、Officer / Captain、Quartermaster、Messenger、Scout、Soldier。  
**社会规则**：命令必须执行；任务优先；资源有限；上级判断可以被实际Proof纠正。  
...
**节奏DNA**：急→更急→商品/新方案→Proof→突然静→新命令重新启动。  
**镜头DNA**：军营跟拍进入军帐；军帐内稳定中景、地图俯拍、商品特写；Proof先结果后Commander Reaction。  
**光声DNA**：清晨/黄昏、帆布、土褐、木色、铁灰；脚步、木车、卷轴、远号角、帐布。  
**商品入口**：Supply Crate、Soldier Personal Gear、Emergency Delivery、Field Demonstration、Quartermaster Inventory。  
**跨商品不变量**：任何商品必须进入“任务/补给/执行”因果链，而不是作为历史美术反差摆设。  
**安全/IP**：No-Weapon Commercial Rule；不用刀枪杀伤、血液、尸体、真实军徽/王朝/军团。  
**Seedance锁定**：pre-battle command camp, no active combat；战争感靠军帐/地图/补给/传令。  
**高风险失败**：模型自动开战、兵器抢戏、战旗生成真实符号、商品古代化、多人军营崩脸。

---

# S04｜MODERN CORPORATE OFFICE
## 现代美国企业办公室

**状态**：TESTING_CANDIDATE  
**世界发动机**：Deadline、结果、职业体面、上下级、信息差。  
**无商品天然冲突**：客户提前、演示失败、文件找不到、谁负责、抢功、老板判断错、新人提出更好方案。  
**人物池**：Employee / Specialist、Coworker、Manager、Executive / Client、Assistant / Coordinator、Intern / New Hire。  
**社会规则**：时间就是价值；结果优先；人必须显得自己知道在干什么；上下级存在但可被能力Proof纠正。  
...
**跨商品不变量**：商品必须改变效率、能力或职业判断，不得退化为办公室里两个人聊天。  
**安全/IP**：无真实公司/软件Logo、CEO、办公空间复刻；不把骚扰/歧视/非法解雇当笑点。  
**Seedance锁定**：ordinary contemporary American corporate office，真实桌面使用痕迹，不未来科技总部。  
**高风险失败**：所有人静坐、电脑乱码、玻璃穿模、桌面资产漂移、sitcom式过度摔文件/翻白眼。

---

# S05｜FICTIONAL AMERICAN FRONTIER TRADING TOWN
## 架空美国西部边疆贸易小镇

**状态**：TESTING_CANDIDATE / NO-WEAPON RULE  
**世界发动机**：陌生人、名声、公开交易、实用主义判断。  
**无商品天然冲突**：谁可信、新货值不值、公开质疑、外来者被低估、老办法与新办法竞争。  
**人物池**：Newcomer / Traveler、Storekeeper、Local Worker / Ranch Hand、Town Regular、Stage Driver / Courier。  
**社会规则**：名声就是信用；少说多做；好不好现场试；陌生人一进镇就会被判断。  
...
**跨商品不变量**：必须保留“别解释，试给我看”的实用主义世界。  
**安全/IP**：Western Standoff without Gunfight；不突出枪械、射击、血腥；不使用原住民族刻板印象/真实西部人物。  
**Seedance锁定**：weathered working frontier trading town，不是主题乐园；Western靠交易/尘土/木镇，不靠枪。  
**高风险失败**：自动枪战、全员同款牛仔帽、商品Western化、尘土变沙尘暴、围观者瞬移。

---

# S06｜FICTIONAL HIGH-SOCIETY GRAND GALA
## 架空现代豪华上流晚宴

**状态**：TESTING_CANDIDATE  
**世界发动机**：身份判断、品味、公开注视、社交体面、Host认可。  
**无商品天然冲突**：谁被邀请/介绍、谁坐哪里、谁被忽略、谁犯礼仪错误、谁突然成为焦点。  
**人物池**：Guest / New Arrival、Host、Established Guest、Friend / Companion、Event Staff、VIP Guest。  
**社会规则**：外表是信息；注意力是社交货币；所有人看见但假装没看；攻击/怀疑必须保持礼貌。  
...
**跨商品不变量**：商品必须改变“谁被注意/谁被认可/谁判断错”，而不是只在豪华背景里展示。  
**安全/IP**：不仿Met Gala、真实慈善/奢侈品牌/名人；不把贫穷、族裔、出身当笑点。  
**Seedance锁定**：private fictional grand gala、diverse adult guests、restrained luxury、分布式Reaction。  
**高风险失败**：自动红毯、全员黑衣、集体转头、商品奢侈化、晚宴变静态Fashion Shoot。

---

# S07｜MODERN AMERICAN SHOPPING MALL
## 现代美国大型购物中心

**状态**：TESTING_CANDIDATE  
**世界发动机**：注意力竞争、比较、试用、选择、朋友/陌生人社会影响。  
**无商品天然冲突**：去哪家店、最后一件、朋友意见冲突、买不买、选哪个、谁推荐错。  
**人物池**：Shopper A、Friend / Companion、Store Associate、Another Shopper、Demo Staff、Passerby。  
**社会规则**：所有东西都在争注意力；比较/试用合法自然；消费者拥有选择权；陌生人Reaction形成社会证明。  
...
**节奏DNA**：Flow→Stop→Gather→Decide。  
**镜头DNA**：Flow Camera；步行双人跟拍、停步Reveal、货架侧中近景、稳定Demo、背景路人渐停。  
**光声DNA**：明亮天窗+商场顶灯；玻璃、浅木、植物；脚步、扶梯、购物袋、店铺远声。  
**商品入口**：Display Discovery、Shopper Personal Item、Friend Recommendation、Try-on / Demo、Pop-up、Shopping Bag、Problem Solver。  
**跨商品不变量**：始终表现“流动购物→发现→比较/试用→Proof→改选”，不能退化为普通货架广告。  
**安全/IP**：全部generic storefront；不生成真实零售Logo、虚构促销价格、未经提供的上架/合作关系。  
**Seedance锁定**：bright contemporary American lifestyle mall，不是机场/豪华酒店；人流受控。  
**高风险失败**：Mall变机场、Logo乱长、人群穿模、商品货架无限复制、路人集体瞬移。

---

# S08｜FICTIONAL INTERPLANETARY COMMERCE METROPOLIS
## 架空未来都市·星际商业世界

**状态**：TESTING_CANDIDATE / WORLD-TECH SEPARATION  
**世界发动机**：系统分类、身份权限、兼容、效率、人工复核。  
**无商品天然冲突**：过检失败、权限错误、物流发错、系统误判、新旧技术不兼容、自动化异常。  
**人物池**：Traveler / Citizen、Trade Inspector、Terminal Staff、Merchant / Demo Specialist、Courier。  
**社会规则**：一切被识别/分类；社会极度优化；系统判断有权威，但现实Proof允许人工Override。  
...
**节奏DNA**：Flow→System Stop→Inspect→Proof→Resume。  
**镜头DNA**：巨大空间1–2秒建立、Flow Tracking、系统停止后稳定中近景、干净商品特写、人工Override。  
**光声DNA**：Bright Functional Future；warm white/silver/graphite/teal/amber；扫描提示、滑轨、自动门、低频交通。  
**商品入口**：Inspection Item、Cargo Delivery、Old-Earth Personal Item、Commerce Display、Daily Use、System Cannot Classify。  
**跨商品不变量**：未来环境可先进，但商品保持今天真实SKU；故事必须来自未来系统如何误解它。  
**安全/IP**：不用Star Wars/Blade Runner/Dune等具体IP；不默认Cyberpunk/战争；严格`WORLD TECH ≠ PRODUCT FACT`。  
**Seedance锁定**：bright lived-in human future commerce，不是科幻机场；HUD不遮商品。  
**高风险失败**：自动Cyberpunk、商品透明发光/加AI功能、环境特效盖产品、机器人过多、伪科学对白。

---

# S09｜FICTIONAL MID-CENTURY AMERICAN ROADSIDE DINER
## 架空复古美国公路Diner

**状态**：TESTING_CANDIDATE  
**世界发动机**：空间距离近、熟客关系、陌生人进入、误听、横向信息传播。  
**无商品天然冲突**：上错餐、坐错位置、隔桌插话、服务员听错、陌生旅客被误解、熟客判断错。  
**人物池**：Server、Regular Customer、Traveler / Newcomer、Friend / Couple、Counter Customer、Cook / Manager。  
**社会规则**：你以为私聊但大家能听见；Server跨不同人群移动，是Information Router；熟客自然插话。  
...
**节奏DNA**：Private→Overheard→Spread→Proof→Embarrassed Reset。  
**镜头DNA**：contained observational comedy；booth双人中景、前中后景多层构图、counter横向Reaction、桌面Proof。  
**光声DNA**：明亮公路Diner；muted red/cream/chrome/turquoise；门铃、咖啡、杯碟、厨房、低声谈话。  
**商品入口**：Traveler Bag、Table Personal Item、New Delivery、Server Discovery、Neighbor Notices、Small Problem Solver。  
**跨商品不变量**：无论商品类别，必须利用“近距离误听/插话/熟客传播”，不能只是两人坐卡座聊天。  
**安全/IP**：不仿真实Diner/Coca-Cola等品牌；包容性成年演员；不浪漫化/复刻种族隔离和真实民权事件。  
**Seedance锁定**：compact lived-in roadside diner，吧台与booth空间关系清晰。  
**高风险失败**：主题乐园化、真实Logo、所有人一起转头、Server端盘/咖啡液体穿模、现代商品被1950s化。

---

# S10｜FICTIONAL HIGH-STAKES COMPETITION SHOW
## 架空高压真人竞赛节目

**状态**：TESTING_CANDIDATE / PROOF-GATED  
**世界发动机**：明确规则、时间压力、公开执行、可见输赢。  
**无商品天然冲突**：谁先完成、谁理解错规则、谁落后、提前庆祝、黑马领先、裁判复核。  
**人物池**：Host、Contestant A、Contestant B、Judge / Referee、Assistant、Audience。  
**社会规则**：规则公开；Claim不算数直到测试；结果必须一眼可见；Host控制开始/停止/确认。  
...
# S11｜FICTIONAL ANCIENT MEDITERRANEAN MARKETPLACE
## 架空古代地中海公共市集

**状态**：TESTING_CANDIDATE  
**世界发动机**：公开叫卖、讨价还价、商人竞争、信誉、群众判断。  
**无商品天然冲突**：争客、砍价、称量争议、外来商人被怀疑、Rival拆台、假货/信誉争议。  
**人物池**：Merchant、Buyer、Rival Merchant、Traveler / Foreign Trader、Market Regular、Passerby。  
**社会规则**：卖东西是公开表演；Claim会被当众挑战；没有评分系统，信任靠亲手检查、公开演示和群众Reaction。  
...
# S12｜FICTIONAL LUXURY LONG-DISTANCE TRAIN
## 架空复古豪华长途列车

**状态**：TESTING_CANDIDATE  
**世界发动机**：封闭移动、车厢顺序、物品归属、服务礼仪、下一站Deadline。  
**无商品天然冲突**：拿错行李、坐错包厢、服务送错、无人认领、下一站将到、陌生人被迫共处。  
**人物池**：Passenger A/B、Conductor、Attendant / Porter、Dining Staff、Traveler / New Boarder。  
**社会规则**：人不能轻易离开；空间有线性顺序；物品归属重要；Attendant/Conductor掌握空间真相；信息随人移动。  
...
**跨商品不变量**：商品/信息必须沿车厢路径移动并发生归属/意义变化，不只是豪华包厢里的聊天。  
**安全/IP**：不仿Orient Express/Pullman/真实铁路Logo和路线；默认Social/Ownership Mystery，不自动谋杀/侦探/枪毒。  
**Seedance锁定**：original luxury train，corridor orientation/window side/door side固定，窗外持续轻微运动。  
**高风险失败**：车厢左右漂移、商品交接穿模、人物像海盗船摇晃、商品复古化、自动谋杀悬疑。

---

# 12-Scene Cross-Product Structural QA

> 这是“结构可迁移QA”，不是Seedance实拍验证。通过表示：同一Scene可在不改变世界发动机的前提下容纳三类差异商品，并能设计真实Proof；不代表生成稳定性已验证。
...
| Scene | 3C | 服装 | 日用品 | 结构结论 |
|---|---|---|---|---|
| S01 宫廷 | PASS | PASS | PASS | 礼仪/权力判断稳定 |
| S02 高中 | PASS | PASS | PASS | 同伴公开判断稳定；受年龄Safety Gate限制 |
| S03 战争军营 | PASS | PASS | PASS | 任务/补给逻辑稳定；No-Weapon规则必须启用 |
| S04 办公室 | PASS | PASS | PASS | 效率/职业判断稳定 |
| S05 西部小镇 | PASS | PASS | PASS | 实用公开检验稳定 |
| S06 豪华晚宴 | PASS | STRONG | PASS | 品味/社会认可稳定 |
| S07 现代商场 | STRONG | STRONG | PASS | 发现/试用/选择稳定 |
| S08 未来商业 | PASS | PASS | STRONG | 系统误判/人工复核稳定 |
| S09 复古Diner | PASS | PASS | STRONG | 误听/横向传播稳定 |
| S10 真人竞赛 | PASS* | PASS* | STRONG | *仅当卖点可短时公平视觉验证 |
| S11 古代市集 | STRONG | PASS | STRONG | 公开Claim/挑战/群众改判稳定 |
| S12 豪华列车 | PASS | PASS | PASS | 物品移动/归属变化稳定 |

结论：12个Scene均通过“跨品结构稳定性”内部QA，因此全部保留为`TESTING_CANDIDATE`；当前没有需要因重复或单品依赖而删除的Scene。

---

# Horizontal Differentiation QA｜防Scene同质化

| Scene | 谁在判断商品/人物 | 最独有的剧情动作 | 核心Reaction路径 |
|---|---|---|---|
| S01 宫廷 | 权力中心 | 呈递/等待许可 | 等级链 |
| S02 高中 | 同龄人+老师 | locker/公开尴尬 | 同伴快速扩散 |
| S03 战争 | 命令链 | 传令/补给/新命令 | Commander→执行链 |
| S04 办公室 | 上司/工作体系 | 汇报/Problem Solving | Manager→Coworker |
| S05 西部 | 小镇社区 | 公开实用检验 | 长静→个人改口 |
| S06 Gala | 社交圈/Host | 注意/侧目/接纳 | 分布式隐性Reaction |
| S07 Mall | 消费者自己 | 发现/试用/改选 | 路人逐步停下 |
| S08 Future | 系统+人工 | 扫描/复核/Override | 系统停→人复核 |
| S09 Diner | 熟客/隔桌/Server | 偷听/插话 | 横向传播 |
| S10 Competition | 规则/Result | 开始/停止/判定 | Host→Loser→Audience |
| S11 Ancient Market | Buyer/Rival/Crowd | 叫卖/公开挑战 | Buyer→Rival→Crowd |
| S12 Train | Passenger/Attendant | 送错/车厢移动 | 线性沿车厢传播 |

若生成后的两个Scene在“人物身份、冲突、动作、Reaction路径、镜头节奏”中有3项以上仍基本一样，视为Scene差异化失败，必须重写。
